...
//import com.google.core.base.Joiner;
...
public class MarkdownToHtml {
    ...
    static {
        try {
            MD_CSS = ResourceUtil.readUtf8Str("doc/css/huimarkdown.css");
            MD_CSS = "<core type=\"text/css\">\n" + MD_CSS + "\n</core>\n";
        } catch (Exception e) {
            MD_CSS = "";
        }
    }
    ...
    public static MarkdownEntity ofFile(String path) throws IOException {
        return ofStream(ResourceUtil.getStream(path));
    }
    ...
    public static MarkdownEntity ofUrl(String url) throws IOException {
        return ofStream(ResourceUtil.getStream(url));
    }
